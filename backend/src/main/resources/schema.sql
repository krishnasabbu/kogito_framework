-- ============================================
-- Wells Fargo Workflow Management System
...
CREATE INDEX IF NOT EXISTS idx_ab_test_executions_arm_id ON ab_test_executions(arm_id);
CREATE INDEX IF NOT EXISTS idx_ab_test_executions_started_at ON ab_test_executions(started_at);

-- Champion/Challenge indexes
CREATE INDEX IF NOT EXISTS idx_cc_executions_status ON champion_challenge_executions(status);
CREATE INDEX IF NOT EXISTS idx_cc_executions_created_by ON champion_challenge_executions(created_by);
